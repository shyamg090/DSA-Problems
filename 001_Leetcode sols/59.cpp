...
//after the row it should start with next row {RIGHT}
//after the col it should start with prev col {DOWN}
//after the row it should start with prev row {LEFT}
//after the col it should start with next col {UP}